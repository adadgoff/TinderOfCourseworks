...
- [ ] Backend
    ...
    - [/] Книги по паттернам
        ...
        - [x] Паттерны разработки на Python - Г. Персиваль.
    - [/] Книги по микросервисам (4 шт)
        - [ ] Создание микросервисов - С. Ньюмен;
        - [x] Building Python Microservices with FastAPI - Sherwin John C. Tragura;
        - [ ] От монолита к микросервисам - С. Ньюмен;
        - [x] Микросервисы. Паттеры разработки и рефакторинга - К. Ричардсон;
    - [ ] Книги по DDD
